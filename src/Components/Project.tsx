	...
	return (
		<ProjectContainer>
			...
			<div className='kartrider'>
				...
				<h4>소개</h4>
				<p>
					넥슨(NEXON)의 온라인 레이싱 게임 카트라이더(Kart Rider)의 전적 검색 서비스인 카트라이더 TMI 를 클로닝하는 프로젝트로써 프론트엔드 개발자로 참여했습니다.
			...
			<div className='chanel'>
				...
				<h4>소개</h4>
				<p>
					우아함과 고급스러움의 대명사인 샤넬의 홈페이지를 클로닝하는 프로젝트로써 프론트엔드 개발자로 참여하였습니다. React의 클래스형 컴포넌트를 사용했으며, 컴포넌트의
			...
			<div>
				...
				<h4>소개</h4>
				<p>
					Angular와 TypeScript를 사용하여 진행했던 넷플릭스 클론 프로젝트입니다. 프론트엔드 3명, 백엔드 2명으로 구성된 팀이었으며, 본인은 '비디오 플레이어 컴포넌트'를
					담당했습니다. 관련 라이브러리로 video.js를 사용했으며, 당시 DOM에 대한 이해가 부족했기에 공부 목적으로 해당 라이브러리의 플러그인을 사용하지 않고 각각의 버튼과 기능을
					직접 구현하였습니다. 특히, 컴포넌트 소멸 시점에 재생된 시간을 로그인 중인 유저의 정보로 저장했다가 이어보기 시 불러오는 작업이 가장 기억에 남습니다.
				</p>
				<h4>사용기술</h4>
				<p>
					- Angular<br />
			...
			<h2 className='vanilla'>
				<IoLogoJavascript className='jsIcon' />Vanilla JavaScript
			</h2>
			<div>
				<h3>
